...
List<DataAchievement> a = [
  ...
  DataAchievement(11, "소문난 망나니", "3연속 탑만 결과로 나온 사람",
      const Text('!', style: TextStyle(fontSize: 40, color: Colors.black87))),
  //12
  DataAchievement(12, "의문의 중국 오리아나 장인", "정교한 미드에서 표식을 찾은 사람",
      const Text('!', style: TextStyle(fontSize: 40, color: Colors.black87))),
  //13
  DataAchievement(13, "결코 지워지지 않을 그 이름", "화려한 미드에서 표식을 찾은 사람",
      const Text('!', style: TextStyle(fontSize: 40, color: Colors.black87))),
  //14
  DataAchievement(14, "결코 지워지지 않을 그 이름", "4개의 미드 결과에서 표식을 전부 찾은 사람",
      const Text('!', style: TextStyle(fontSize: 40, color: Colors.black87))),
